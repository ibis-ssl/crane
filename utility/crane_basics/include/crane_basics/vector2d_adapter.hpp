...
struct access<crane::Vector2d, 0>
{
  ...
  static auto set(crane::Vector2d & p, double const & value) -> void { p.x(value); } // Use x(value)
};
...
struct access<crane::Vector2d, 1>
{
  ...
  static auto set(crane::Vector2d & p, double const & value) -> void { p.y(value); } // Use y(value)
};
}  // namespace boost::geometry::traits
