...
#ifndef CRANE_GEOMETRY__VECTOR3D_HPP_
#define CRANE_GEOMETRY__VECTOR3D_HPP_
...
// 外部演算子
inline Vector3d operator*(double scalar, const Vector3d & vec) { return vec * scalar; }
...
#endif  // CRANE_GEOMETRY__VECTOR3D_HPP_
