...
// NodeBaseInterface
template<>
inline std::shared_ptr<rclcpp::node_interfaces::NodeBaseInterface> get_interface_from_node<rclcpp::node_interfaces::NodeBaseInterface>(rclcpp::Node& node) {
  return node.get_node_base_interface();
}

// NodeClockInterface
template<>
inline std::shared_ptr<rclcpp::node_interfaces::NodeClockInterface> get_interface_from_node<rclcpp::node_interfaces::NodeClockInterface>(rclcpp::Node& node) {
  return node.get_node_clock_interface();
}

// NodeGraphInterface
template<>
inline std::shared_ptr<rclcpp::node_interfaces::NodeGraphInterface> get_interface_from_node<rclcpp::node_interfaces::NodeGraphInterface>(rclcpp::Node& node) {
  return node.get_node_graph_interface();
}

// NodeLoggingInterface
template<>
inline std::shared_ptr<rclcpp::node_interfaces::NodeLoggingInterface> get_interface_from_node<rclcpp::node_interfaces::NodeLoggingInterface>(rclcpp::Node& node) {
  return node.get_node_logging_interface();
}

// NodeTimeSourceInterface
template<>
inline std::shared_ptr<rclcpp::node_interfaces::NodeTimeSourceInterface> get_interface_from_node<rclcpp::node_interfaces::NodeTimeSourceInterface>(rclcpp::Node& node) {
  return node.get_node_time_source_interface();
}

// NodeTimersInterface
template<>
std::shared_ptr<rclcpp::node_interfaces::NodeTimersInterface> get_interface_from_node<rclcpp::node_interfaces::NodeTimersInterface>(rclcpp::Node& node) {
  return node.get_node_timers_interface();
}

// NodeTopicsInterface
template<>
inline std::shared_ptr<rclcpp::node_interfaces::NodeTopicsInterface> get_interface_from_node<rclcpp::node_interfaces::NodeTopicsInterface>(rclcpp::Node& node) {
  return node.get_node_topics_interface();
}

// NodeWaitablesInterface
template<>
inline std::shared_ptr<rclcpp::node_interfaces::NodeWaitablesInterface> get_interface_from_node<rclcpp::node_interfaces::NodeWaitablesInterface>(rclcpp::Node& node) {
