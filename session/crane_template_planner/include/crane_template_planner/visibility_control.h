...
#ifndef CRANE_TEMPLATE_PLANNER__VISIBILITY_CONTROL_H_
#define CRANE_TEMPLATE_PLANNER__VISIBILITY_CONTROL_H_
...
#endif  // CRANE_TEMPLATE_PLANNER__VISIBILITY_CONTROL_H_
