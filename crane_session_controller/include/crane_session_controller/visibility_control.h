...
#ifndef CRANE_SESSION_CONTROLLER__VISIBILITY_CONTROL_H_
#define CRANE_SESSION_CONTROLLER__VISIBILITY_CONTROL_H_
...
#endif  // CRANE_SESSION_CONTROLLER__VISIBILITY_CONTROL_H_
