...
int main()
{
  ...
  auto agent1 = simulator.addAgent(
    modern_orca::Vector2D{-2.0, 0.0},  // position
    modern_orca::Vector2D{2.0, 0.0},   // preferred velocity
    2.0,                               // max speed
    0.5                                // radius
  );
  ...
  auto agent3 = simulator.addAgent(
    modern_orca::Vector2D{0.0, -2.0},  // position
    modern_orca::Vector2D{0.0, 2.0},   // preferred velocity
    2.0,                               // max speed
    0.5                                // radius
  );
  ...
  simulator.addGlobalConstraint<modern_orca::BoundaryConstraint<modern_orca::CircularAgent>>(
    modern_orca::Vector2D{-5.0, -5.0},  // min bounds
    modern_orca::Vector2D{5.0, 5.0},    // max bounds
    0.1                                 // margin
  );

  simulator.addConstraint<modern_orca::CircularObstacleConstraint<modern_orca::CircularAgent>>(
    agent1, modern_orca::Vector2D{0.0, 0.0},  // obstacle center
    0.3                                       // obstacle radius
  );
