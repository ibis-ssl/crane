...
**[NEEDS EXPERT REVIEW]** このドキュメントに記載されているルール違反への対応状況や、関連するGitHubイシューのステータ스는、プロジェクトのドメインエキスパートによって定期的にレビューされ、現在のコードベースおよびプロジェクトの状況に合わせて更新される必要があります。
...
故意に固まるようなプログラムはないが、特にディフェンス時に似た状況に陥りやすいかもしれない。
