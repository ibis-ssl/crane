...
Craneシステムにおけるオフェンス戦術は、`crane_robot_skills`パッケージのスキルベースアーキテクチャと`crane_planner_plugins`の戦略Tacticにより実現されています。
...
- **[crane_planner_plugins](./packages/crane_planner_plugins.md)** - 戦略Tacticの統合実装
