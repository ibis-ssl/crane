...
- **[開発進捗](./progress.md)** - 2024年最新の開発状況と機能概要
...
- ✅ **基盤パッケージ**: 4/4 完了 (crane_msgs, crane_world_model_publisher, crane_robot_skills, crane_session_controller)
- 🚧 **その他パッケージ**: 28パッケージ作成中
...
- **12月**: ボールフィルタ実装・3Dボールモデル拡充
- **11月**: Vector3d導入・Claude Code開発ドキュメント追加  
- **継続中**: EKFベースボールトラッキング・可視化API改善
