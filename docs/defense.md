...
> **最終更新**: 2026年1月
> **関連パッケージ**: [crane_sessions](./packages/crane_sessions.md), [crane_robot_skills](./packages/crane_robot_skills.md)
...
**詳細な実装**: [crane_sessions](./packages/crane_sessions.md) と [crane_robot_skills](./packages/crane_robot_skills.md) を参照
