...
#ifndef CRANE_ROBOT_SKILLS__KICK_VEL_HPP_
#define CRANE_ROBOT_SKILLS__KICK_VEL_HPP_
...
{
class KickVel : public SkillBase<RobotCommandWrapperSimpleVelocity>
{
public:
  explicit KickVel(RobotCommandWrapperBase::SharedPtr & base)
  : SkillBase("KickVel", base), phase(getContextReference<std::string>("phase"))
  {
...
#endif  // CRANE_ROBOT_SKILLS__KICK_VEL_HPP_
