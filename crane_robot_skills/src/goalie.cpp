...
void Goalie::emitBallFromPenaltyArea(RobotCommandWrapper & target)
{
  ...
  if (dot < 0.95 || std::abs(getAngleDiff(angle_ball_to_target, target.robot->pose.theta)) > 0.05) {
...
void Goalie::inplay(RobotCommandWrapper & target, bool enable_emit)
{
