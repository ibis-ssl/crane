...
#include <crane_robot_skills/cut_pass.hpp>

namespace crane::skills
{
CutPass::CutPass(RobotCommandWrapperBase::SharedPtr & base) : SkillBase("CutPass", base)
{
...
Status CutPass::update(const ConsaiVisualizerWrapper::SharedPtr & visualizer)
{
...
Point CutPass::getInterceptionPoint() const
{
