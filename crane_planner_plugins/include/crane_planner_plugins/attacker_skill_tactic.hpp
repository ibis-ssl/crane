...
#ifndef CRANE_PLANNER_PLUGINS__ATTACKER_SKILL_TACTIC_HPP_
#define CRANE_PLANNER_PLUGINS__ATTACKER_SKILL_TACTIC_HPP_
...
#endif  // CRANE_PLANNER_PLUGINS__ATTACKER_SKILL_TACTIC_HPP_
