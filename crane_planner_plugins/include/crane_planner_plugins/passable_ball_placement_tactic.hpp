...
#ifndef CRANE_PLANNER_PLUGINS__PASSABLE_BALL_PLACEMENT_TACTIC_HPP_
#define CRANE_PLANNER_PLUGINS__PASSABLE_BALL_PLACEMENT_TACTIC_HPP_
...
#endif  // CRANE_PLANNER_PLUGINS__PASSABLE_BALL_PLACEMENT_TACTIC_HPP_
