...
#ifndef CRANE_PLANNER_PLUGINS__TEST_TACTIC_HPP_
#define CRANE_PLANNER_PLUGINS__TEST_TACTIC_HPP_
...
namespace crane
{
class TestTactic : public TacticBase
{
public:
  COMPOSITION_PUBLIC explicit TestTactic(
...
#endif  // CRANE_PLANNER_PLUGINS__TEST_TACTIC_HPP_
