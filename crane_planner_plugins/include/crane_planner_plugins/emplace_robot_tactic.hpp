...
#ifndef CRANE_PLANNER_PLUGINS__EMPLACE_ROBOT_TACTIC_HPP_
#define CRANE_PLANNER_PLUGINS__EMPLACE_ROBOT_TACTIC_HPP_
...
#endif  // CRANE_PLANNER_PLUGINS__EMPLACE_ROBOT_TACTIC_HPP_
