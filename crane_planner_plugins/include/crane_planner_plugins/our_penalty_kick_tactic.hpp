...
#ifndef CRANE_PLANNER_PLUGINS__OUR_PENALTY_KICK_TACTIC_HPP_
#define CRANE_PLANNER_PLUGINS__OUR_PENALTY_KICK_TACTIC_HPP_
...
#endif  // CRANE_PLANNER_PLUGINS__OUR_PENALTY_KICK_TACTIC_HPP_
