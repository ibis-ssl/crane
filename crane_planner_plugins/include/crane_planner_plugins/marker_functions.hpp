...
#ifndef CRANE_PLANNER_PLUGINS__MARKER_FUNCTIONS_HPP_
#define CRANE_PLANNER_PLUGINS__MARKER_FUNCTIONS_HPP_
...
#endif  // CRANE_PLANNER_PLUGINS__MARKER_FUNCTIONS_HPP_
