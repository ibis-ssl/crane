...
#ifndef CRANE_PLANNER_PLUGINS__SIMPLE_AI_TACTIC_HPP_
#define CRANE_PLANNER_PLUGINS__SIMPLE_AI_TACTIC_HPP_
...
class SimpleAITactic : public TacticBase
{
public:
  COMPOSITION_PUBLIC explicit SimpleAITactic(
...
#endif  // CRANE_PLANNER_PLUGINS__SIMPLE_AI_TACTIC_HPP_
