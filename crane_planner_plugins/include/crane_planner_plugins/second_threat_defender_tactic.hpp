...
#ifndef CRANE_PLANNER_PLUGINS__SECOND_THREAT_DEFENDER_TACTIC_HPP_
#define CRANE_PLANNER_PLUGINS__SECOND_THREAT_DEFENDER_TACTIC_HPP_
...
namespace crane
{
class SecondThreatDefenderTactic : public TacticBase
{
public:
  COMPOSITION_PUBLIC
  explicit SecondThreatDefenderTactic(WorldModelWrapper::SharedPtr & world_model, rclcpp::Node &)
  : TacticBase("second_threat_defender", world_model)
  {
  }
...
#endif  // CRANE_PLANNER_PLUGINS__SECOND_THREAT_DEFENDER_TACTIC_HPP_
