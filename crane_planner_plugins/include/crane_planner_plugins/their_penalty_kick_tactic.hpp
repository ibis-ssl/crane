...
#ifndef CRANE_PLANNER_PLUGINS__THEIR_PENALTY_KICK_TACTIC_HPP_
#define CRANE_PLANNER_PLUGINS__THEIR_PENALTY_KICK_TACTIC_HPP_
...
#endif  // CRANE_PLANNER_PLUGINS__THEIR_PENALTY_KICK_TACTIC_HPP_
