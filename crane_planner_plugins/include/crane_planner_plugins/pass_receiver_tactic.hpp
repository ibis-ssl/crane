...
#ifndef CRANE_PLANNER_PLUGINS__PASS_RECEIVER_TACTIC_HPP_
#define CRANE_PLANNER_PLUGINS__PASS_RECEIVER_TACTIC_HPP_
...
namespace crane
{
class PassReceiverTactic : public TacticBase
{
public:
    ...
    const std::vector<RobotIdentifier> & robots) override
  {
    ...
    if (world_model->ball().isMoving(1.0) || our_kick_ongoing) {
      ...
      return {static_cast<TacticBase::Status>(status), {receive_skill->getRobotCommand()}};
    }
...
#endif  // CRANE_PLANNER_PLUGINS__PASS_RECEIVER_TACTIC_HPP_
