...
#ifndef CRANE_PLANNER_PLUGINS__TOTAL_DEFENSE_TACTIC_HPP_
#define CRANE_PLANNER_PLUGINS__TOTAL_DEFENSE_TACTIC_HPP_
...
namespace crane
{
class TotalDefenseTactic : public TacticBase
{
public:
...
#endif  // CRANE_PLANNER_PLUGINS__TOTAL_DEFENSE_TACTIC_HPP_
