...
protected:
  void SetUp() override
  {
    ...
    modern_node_ = std::make_shared<rclcpp::Node>("modern_planner_node_" + std::to_string(test_counter_));
    rvo2_node_ = std::make_shared<rclcpp::Node>("rvo2_planner_node_" + std::to_string(test_counter_));
