...
#ifndef CRANE_RORATION_PLANNER__VISIBILITY_CONTROL_H_
#define CRANE_RORATION_PLANNER__VISIBILITY_CONTROL_H_
...
#endif  // CRANE_RORATION_PLANNER__VISIBILITY_CONTROL_H_
