...
#include <crane_tactics/attacker_skill_tactic.hpp>
#include <crane_tactics/ball_calibration_data_collector_tactic.hpp>
#include <crane_tactics/center_stop_kick_tactic.hpp>
#include <crane_tactics/defender_tactic.hpp>
#include <crane_tactics/emplace_robot_tactic.hpp>
#include <crane_tactics/formation_tactic.hpp>
#include <crane_tactics/forward_tactic.hpp>
#include <crane_tactics/marker_tactic.hpp>
#include <crane_tactics/our_free_kick_tactic.hpp>
#include <crane_tactics/our_penalty_kick_tactic.hpp>
#include <crane_tactics/pass_receiver_tactic.hpp>
