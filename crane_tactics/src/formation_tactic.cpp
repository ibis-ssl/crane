...
namespace crane
{
std::vector<Point> FormationTactic::getWingFormationPoints(int robot_num)
{
...
std::vector<Point> FormationTactic::getIbisFormationPoints(int robot_num)
{
  std::vector<Point> formation_points;
...
FormationTactic::calculatePositionCommand(const std::vector<RobotIdentifier> & robots)
{
...
auto FormationTactic::getSelectedRobots(
