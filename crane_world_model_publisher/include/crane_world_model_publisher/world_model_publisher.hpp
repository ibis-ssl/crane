...
private:
  ...
  bool ball_event_was_detected =
    false;                          // True if a kick/collision type event was detected this frame
  ...
  std::deque<crane_msgs::msg::BallInfo>
    ball_info_history_for_event_detection;  // Short history for event detection
