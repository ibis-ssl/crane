...
#ifndef CRANE_PASS_FACILITATOR__VISIBILITY_CONTROL_H_
#define CRANE_PASS_FACILITATOR__VISIBILITY_CONTROL_H_
...
#endif  // CRANE_PASS_FACILITATOR__VISIBILITY_CONTROL_H_
