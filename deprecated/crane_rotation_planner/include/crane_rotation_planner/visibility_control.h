...
#ifndef CRANE_ROTATION_PLANNER__VISIBILITY_CONTROL_H_
#define CRANE_ROTATION_PLANNER__VISIBILITY_CONTROL_H_
...
#endif  // CRANE_ROTATION_PLANNER__VISIBILITY_CONTROL_H_
