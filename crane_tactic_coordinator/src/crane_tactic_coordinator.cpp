...
namespace crane
{
TacticCoordinatorComponent::TacticCoordinatorComponent(const rclcpp::NodeOptions & options)
  ...
  diagnostic_updater_(this)
{
  ...
  // プランナー管理の初期化
  tactic_registry_ = std::make_shared<TacticRegistry>();
  ...
  diagnostic_updater_.add(
    "ai_planner/planning_cycle", this, &TacticCoordinatorComponent::updateDiagnostics);
}

auto TacticCoordinatorComponent::assign(const std::string & event_name) -> void
{
...
auto TacticCoordinatorComponent::onWorldModelUpdate() -> void
{
...
auto TacticCoordinatorComponent::updateDiagnostics(
...
RCLCPP_COMPONENTS_REGISTER_NODE(crane::TacticCoordinatorComponent)
