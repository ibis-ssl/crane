...
#ifndef CRANE_TACTIC_COORDINATOR__VISIBILITY_CONTROL_H_
#define CRANE_TACTIC_COORDINATOR__VISIBILITY_CONTROL_H_
...
#endif  // CRANE_TACTIC_COORDINATOR__VISIBILITY_CONTROL_H_
